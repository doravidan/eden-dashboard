...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    prs: [
      ...
      { repo: 'wheel2go', number: 1, title: 'feat(api): Implement toll notifications and S3 upload', url: 'https://github.com/doravidan/wheel2go/pull/1', status: 'merged', createdAt: '2026-01-27T22:09:40Z' },
      { repo: 'wheel2go', number: 2, title: 'feat(api): Implement password reset email notification', url: 'https://github.com/doravidan/wheel2go/pull/2', status: 'merged', createdAt: '2026-01-27T22:12:27Z' },
      { repo: 'wheel2go', number: 3, title: 'fix: resolve TypeScript errors in UI and admin packages', url: 'https://github.com/doravidan/wheel2go/pull/3', status: 'merged', createdAt: '2026-01-27T22:35:22Z' },
